...
__problem_title__ = "XOR decryption"
__problem_url___ = "https://projecteuler.net/problem=59"
__problem_description__ = "Each character on a computer is assigned a unique code and the " \
                          "preferred standard is ASCII (American Standard Code for Information " \
                          "Interchange). For example, uppercase A = 65, asterisk (*) = 42, and " \
                          "lowercase k = 107. A modern encryption method is to take a text file, " \
                          ...
                          "text; for example, 65 XOR 42 = 107, then 107 XOR 42 = 65. For " \
                          "unbreakable encryption, the key is the same length as the plain text " \
                          ...
                          "consists of three lower case characters. Using (right click and 'Save " \
